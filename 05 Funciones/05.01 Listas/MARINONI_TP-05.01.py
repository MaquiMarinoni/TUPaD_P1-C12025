...
elementos = ["gatos", True, 2, "uva", 5.6]	
print(elementos[-2])
...
print(f"Tu lista inicial es: {animales}. Ahora reemplazaremos el segundo y último valor.")
animales[1] = "loro"
animales[-1] = "oso"
print(f"Tu nueva lista es: {animales}")
