...
"""## Ejercicio 7: Escribir un programa que solicite una frase o palabra al usuario. Si la última letra del string es una vocal, añadir un signo de exclamación al final."""
...
"""## Ejercicio 8: Escribir un programa que solicite al usuario que ingrese su nombre y el número 1, 2 o 3 dependiendo de la acción que desea realizar."""
